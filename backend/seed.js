...
const subjects = ['Toán học', 'Vật lý', 'Hóa học', 'Sinh học', 'Ngữ văn', 'Tiếng Anh', 'Lịch sử', 'Địa lý', 'GDCD', 'Tin học', 'Công nghệ'];
const typesDocument = ['PDF', 'Word', 'Excel', 'PowerPoint', 'Video'];
const typesExam = ['PDF', 'Word', 'Quiz'];
const documentVariations = [
    { title: "Chuyên đề nâng cao", desc: "Tài liệu chuyên sâu giúp học sinh nắm vững kiến thức trọng tâm." },
    { title: "Bài giảng lý thuyết", desc: "Tổng hợp toàn bộ lý thuyết cơ bản một cách trực quan, dễ hiểu." },
    { title: "Hướng dẫn giải bài tập", desc: "Phân tích và giải chi tiết các dạng bài tập điển hình thường gặp." },
    { title: "Tổng hợp công thức", desc: "Sổ tay công thức rút gọn, thuận tiện cho việc tra cứu nhanh." },
    { title: "Tài liệu tham khảo", desc: "Cung cấp thêm kiến thức mở rộng ngoài sách giáo khoa." }
];
